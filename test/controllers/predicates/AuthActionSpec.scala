...
class AuthorisedActionSpec extends AnyWordSpec with Matchers {
  ...
  "Auth Action" should {
      ...
      "the user is authorised as an individual" in {
        ...
        running(app) {
          ...
          val enrolments: Enrolments = Enrolments(Set(
            Enrolment(models.Enrolment.MtdIncomeTax.key, Seq(EnrolmentIdentifier(models.Enrolment.MtdIncomeTax.value, "1234567890")), "Activated")
          ))
    ...
    "return with a identifier Request" when {
