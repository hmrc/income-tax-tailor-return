...
object TailoringModels {
  ...
  val aWorkBenefitModel: WorkBenefitsModel = WorkBenefitsModel(Some(true),Some(true),Some(true))

  val aGainsTrustsEstatesModel: GainsTrustsEstatesModel = GainsTrustsEstatesModel(Some(true),Some(true),Some(true))

  val aRentalsPensionsInvestmentsModel: RentalsPensionsInvestmentsModel = RentalsPensionsInvestmentsModel(None,Some(true),Some(true))

  val aPensionsPaymentsModel: PensionsPaymentsModel = PensionsPaymentsModel(Some(true),Some(true),Some(true))

  val aAllowancesTaxReliefModel : AllowancesTaxReliefModel = AllowancesTaxReliefModel(Some(true),Some(true),Some(true))
